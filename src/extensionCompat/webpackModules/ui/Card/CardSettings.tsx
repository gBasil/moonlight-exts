...
function Setting({ name, setting }: SettingsProps) {
	...
	return React.createElement(element, { extId, name, setting });
}

export default function CardSettings({ settings }: {
	settings: Record<string, ExtensionSettingsManifest>;
}) {
	return (
		// TODO: Check if we need `className="moonbase-settings"`
		<Flex direction={Flex.Direction.VERTICAL}>
